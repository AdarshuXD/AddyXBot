...
from AddyX import YouTube, app
from AddyX.core.call import Addy
from AddyX.misc import SUDOERS, db
from AddyX.utils import bot_sys_stats
from AddyX.utils.database import (
    get_active_chats,
    get_lang,
    is_active_chat,
    is_music_playing,
...
from AddyX.utils.formatters import seconds_to_min
from AddyX.utils.inline import (
    stream_markup,
    stream_markup_timer,
    telegram_markup,
...
from AddyX.utils.stream.autoclear import auto_clean
from AddyX.utils.thumbnails import gen_thumb
    ...
    if command == "Pause":
        ...
        if "live_" in queued:
            ...
            try:
                ...
                image = None
            try:
                await Addy.skip_stream(chat_id, link, video=status, image=image)
            except Exception:
                return await CallbackQuery.message.reply_text(
                    _["call_9"]
                )
            ...
            if videoid == "telegram":
                ...
                try:
                    ...
                    image = None
            try:
                await Addy.skip_stream(chat_id, queued, video=status, image=image)
            except Exception:
                return await CallbackQuery.message.reply_text(
                    _["call_9"]
                )
