...
from AddyX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AddyX.core.call import Addy
from AddyX.utils import seconds_to_min, time_to_seconds
from AddyX.utils.channelplay import get_channeplayCB
from AddyX.utils.database import is_video_allowed
from AddyX.utils.decorators.language import languageCB
from AddyX.utils.decorators.play import PlayWrapper
from AddyX.utils.formatters import formats
from AddyX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AddyX.utils.database import is_served_user
from AddyX.utils.inline.playlist import botplaylist_markup
from AddyX.utils.logger import play_logs
from AddyX.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("AddyymousAdmin") & ~BANNED_USERS
)
async def Addyymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("AddyPlaylists") & ~BANNED_USERS
)
@languageCB
