...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AddyX/assets/Addyx.png")
        ...
        font = ImageFont.truetype("AddyX/assets/font2.ttf", 45)
        ImageFont.truetype("AddyX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("AddyX/assets/font2.ttf", 30)
        ImageFont.truetype("AddyX/assets/font.ttf", 30)
